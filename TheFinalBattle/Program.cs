namespace TheFinalBattle
{
    public class Program
    {
        public static void Main()
        {
            ...
            Party heroes = new Party(new HumanPlayer(), new List<Character> { new TrueProgrammer() }, new List<Item> { new HealthPotion(), new HealthPotion(), new HealthPotion(), new Sword() });
            Party monsters_1 = new Party(new ComputerPlayer(), new List<Character> { new Skeleton() }, new List<Item> { new HealthPotion(), new Dagger() });
